...
const seedDatabase = async () => {
  try {
    ...
    // Create songs with tags and default values
    const createdSongs = await Song.insertMany([
      ...
      // Add other Bruno Mars songs with same tag structure...
...
const artistAlbums = [
  ...
  // Insert artist albums and update songs
  ...
  // Process tags for tag-based albums
  ...
  // Process all songs for tag-based collections
